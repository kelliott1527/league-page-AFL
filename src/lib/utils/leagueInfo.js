...
export const homepageText = `
  <p>I promise I will update this. </p>
  <p>Also congrats to Zak! </p>
`;
...
export const managers = [
    {
      ...
      "photo": "/managers/kylee.png", // square ratio recommended (no larger than 500x500)
      ...
      "rival": {
        ...
        image: "/managers/kylee.png", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
      },
      "favoritePlayer": null, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
      "valuePosition": "K", // (optional) Favorite position (QB, WR, RB, TE, etc.)
      "rookieOrVets": "Rookies", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
      "philosophy": "Just doing my best",
    ...
    },
    {
      ...
      "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
        name: "Boyd", // Can be anything (usually your rival's name)
